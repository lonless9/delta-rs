...
pub(crate) const COL_NUM_RECORDS: &str = "numRecords";
pub(crate) const COL_MIN_VALUES: &str = "minValues";
pub(crate) const COL_MAX_VALUES: &str = "maxValues";
pub(crate) const COL_NULL_COUNT: &str = "nullCount";
